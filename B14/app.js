...
// bài 2
// function makeShortUsersInfo(users) {
//     let result = [];
...
//         result.push(newUserInfo);
//     }

//     return result;
// }

// let newUsers = makeShortUsersInfo(users);
// console.log(newUsers);
// console.log(users);

// bài 3:
// users: mảng, keys: mảng
// ['ny']
function makeShortUsersByKeys(users, keys) {
    let result = [];
    ...
    for (let user of users) {
        ...
        // lặp qua từng key
        for (let key of keys) {
            // kiểm tra key có tồn tại trong user hay không
            if (user[key] != undefined) newUser[key] = user[key]; // gán giá trị
        }
...
let keys = ['first_name', 'last_name', 'age', 'gender'];
let newUsers = makeShortUsersByKeys(users, keys);
console.log(newUsers);
...
console.log(girlfriend.first_name);
girlfriend.first_name = 'Linh';
girlfriend.father = 'Daddy';

// let key = 'age';
// console.log(girlfriend[key]); // = girlfriend['age']